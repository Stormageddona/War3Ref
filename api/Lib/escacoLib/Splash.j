...
library Splash
    ...
    struct splash extends array
        ...
        static method operator owner takes nothing returns player
            return PSRC
        endmethod
        static method operator GetX takes nothing returns real
            return X
        endmethod
        static method operator GetY takes nothing returns real
            return Y
        endmethod
        ...
        static method zone takes boolexpr f, unit src, real x, real y, real w, real h, code c returns nothing
            ...
            set ppsrc = null
        endmethod
        static method rect takes boolexpr f, player p, rect r, code c returns nothing
            local group ul = CreateGroup()
            //unitList.create()
            local player ppsrc = PSRC
            set PSRC = p
        ...
        endmethod
    endstruct
        function SplashRange takes boolexpr f, unit src, real x, real y, real rng, code c returns nothing
            call splash.range(f,src,x,y,rng,c)
        endfunction
        function SplashZone takes  boolexpr f, unit src, real x, real y, real w, real h, code c returns nothing
            call splash.zone(f,src,x,y,w,h,c)
        endfunction
        function SplashRect takes boolexpr f, player psrc, rect r, code c returns nothing
            call splash.rect(f,psrc,r,c)
        endfunction
endlibrary
